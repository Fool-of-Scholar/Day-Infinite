...
public partial class HUD : CanvasLayer
{
	...
	public override void _Ready()
	{
		...
		_btnSpeed = GetNode<Button>("UpgradeMenu/PanelContainer/MarginContainer/HBoxContainer/BtnSpeed");
		_btnHealth = GetNode<Button>("UpgradeMenu/PanelContainer/MarginContainer/HBoxContainer/BtnHealth");
		_btnDamage = GetNode<Button>("UpgradeMenu/PanelContainer/MarginContainer/HBoxContainer/BtnDamage");
